        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Link to="/admin/login" className="block">
            <div className="glass-card p-6 text-center hover:border-primary/50 transition-all group cursor-pointer h-full">
              ...
              <h2 className="text-lg font-semibold text-foreground mb-2">Admin Login</h2>
              <p className="text-xs text-muted-foreground">Access the analytics dashboard and complaint management system</p>
            </div>
          </Link>
        </div>
      </motion.div>
